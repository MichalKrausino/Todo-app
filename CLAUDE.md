...
- [ ] Fáze 8 — Todoist: sdílené projekty klientů a jejich úkoly do appky. Průzkum API, architektura (token na serveru, edge funkce `todoist`) a mapování dat v **`docs/TODOIST.md`** — čeká na rozhodnutí o rozsahu, kód zatím žádný
