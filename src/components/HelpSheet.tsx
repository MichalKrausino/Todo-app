...
const SYNTAX: Array<{ example: string; means: string }> = [
  ...
  { example: 'do konce týdne shrnutí', means: 'do pátku (stejně „tento týden", „za týden")' },
  { example: 'zavolat Pepovi do 14:00', means: 'termín i s časem' },
  { example: 'schůzka v 10', means: 'čas i bez dvojtečky („v 8 ráno", „v 7 večer")' },
  ...
  { example: 'každý pátek report', means: 'opakující se úkol (i „každé první pondělí v měsíci")' },
