  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        scope: base,
        display: 'standalone',
        // Splash i lišta musí být `--color-paper`, ne studená iOS šeď:
        // appka se jinak při startu z plochy převlékne — nejdřív #f2f2f7
        // ze splashe, pak teprve teplý papír. Tři šedé cestou dovnitř.
